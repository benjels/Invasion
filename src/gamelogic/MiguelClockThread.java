...
public class MiguelClockThread extends Thread {
	...
	private final MiguelServer serverGame; // the server game main class that we will be giving the pulses to


	public MiguelClockThread(int delay, MiguelServer serverGame) {
		this.interval = delay;
