...
public class MiguelListener {

	private GameGui gui;
	private GameSetUpWindow setUpGui;
	private PracticeSlave dummySlave;// hardcoded event field

	public MiguelListener(GameGui gui, GameSetUpWindow setUp, PracticeSlave slave){
		this.gui = gui;
		this.setUpGui = setUp;
